...
function LineTable(props: any) {
    ...
    return (
        <div>
            <div className="list">
                <div>
                    <a onClick={() => setAccordion(!accordion)}>
                        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.375 10.4062V0.0937494H6.125V10.4062H4.375ZM0.0937501 6.125V4.375H10.4063V6.125H0.0937501Z" fill="#004A8D" />
                        </svg>
                    </a>
                </div>
                <div>{item.unit}</div>
                ...
                <div>
                    <div className="actions">
                        ...
                        <a onClick={() => props.onItemChange(item)} className="btn-action">
            ...
            <div style={{ padding: '15px 0 15px 46px' }} className={accordion === false ? 'accordion' : 'accordion-none'}>
