...
export function News_Card() {

  const imageSrc110 = require("../../../assets/img/Rectangle 110.png");
  const imageSrc111 = require("../../../assets/img/Rectangle 111.png");
  const imageSrc112 = require("../../../assets/img/Rectangle 112.png");
  const imageSrc113 = require("../../../assets/img/Rectangle 113.png");
      ...
      <div className="news__card container">
          ...
          <div className="row justify-content-center">
              <div className="col-5 col-md-9 col-lg-8 col-sm-8">
                ...
                <span className="border-bottom border border-light"></span>
              </div>
          ...
          <div className="row justify-content-center my-4">
              <div className="col-lg-10">
                <h4 className='fw-bold'>Galeria de Fotos</h4>
              </div>
          </div>
          <div className="row justify-content-center my-4">
              <div className="col-lg-10">
              <img src={imageSrc110} className="img-fluid" alt="img_programação" />
              </div>
          </div>
          <div className="row justify-content-center mx-1 mb-5">
              <div className="col-lg-10 col-md-5">
              <img src={imageSrc111} className="img-fluid mx-3 my-4" alt="img_programação" />
              <img src={imageSrc112} className="img-fluid mx-3 my-4" alt="img_programação" />
              <img src={imageSrc113} className="img-fluid mx-3 my-4" alt="img_programação" />
              </div>
          </div>
       </div>
      </>
